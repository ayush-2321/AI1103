...
Let $X \in \{2,12\}$ be a discrete random variable which denotes the sum obtained on two dice.
...
\begin{tabular}{|c|c|}
\hline
result on die 1 & Result on die 2  \\  \hline
...
\begin{align}
  \text{So, from table,}  \pr{X=8}= \frac{5}{36} \notag
\end{align}
